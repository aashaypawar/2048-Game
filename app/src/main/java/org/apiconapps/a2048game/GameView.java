...
public class GameView extends GridLayout {
    ...
    private void checkGameOver() {
        ...
        if (isOver) {
            new AlertDialog.Builder(getContext()).setTitle("Game Over").setMessage("Your Score is "+MainActivity.score+". Play again?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                @Override
